...
//};
#define ASCII_OFFSET	32		//œ¬√ÊµƒASCII÷–∞—«∞32∏ˆ≤ªƒ‹œ‘ æµƒ»•µÙ¡À
...
#define STR_CHINESE "≤…—˘…Ë÷√∑€≥æ ±º‰∏Ù¥Œ ˝∆Ù∂Øµ±«∞—”µ˜¡„¥Û∆¯ ™∂»—π¡¶π§øˆ±ÍÃÂª˝≈‰“«∆˜œ‘ æ√‹¬Î–ﬁ∏ƒª“¡¡∂®≤‚¡øœﬁ±£ª§øÿ÷∆Õ£µÁº”»»ø™πÿÀÆ∆˚≤ª≤Œ”Îº∆À„Œ¨ª§º«¬º∞Ê±æ±∂¬ ≤Ó∆‰À˚°Ê"
...
int CHD_Get_code(char *buf, char *c, short buf_size, char font, char size)
{
	...
	//ÊòæÁ§∫Ê±âÂ≠ó
	count = 0;
	//ÈÄöËøáÂØπÊØîunicodeÁºñÁ†ÅÊù•Á°ÆÂÆöÂÅèÁßª‰ΩçÁΩÆ
	while(p_chinese[count])
	{
		...
		//ÂÜçÊØîËæÉÁ¨¨‰∫å‰∏™ÁºñÁ†ÅÔºå‰∏§‰∏™ÁºñÁ†ÅÈÉΩ‰∏ÄÊ†∑Êó∂ÔºåÊâçÂåπÈ
		count ++;
